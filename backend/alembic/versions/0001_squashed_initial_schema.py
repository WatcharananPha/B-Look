...
Squash of all previous migrations into a single authoritative baseline:
  a2dd559b6618  Complete_Initial_Schema
  b1f3c9a6d8a1  add_order_uuid_and_slips
  c3e5f1a9b2d3  add_mockup_urls
  f1d407d87638  restore_neck_types (data seed)
  d4e7b3f9a1c2  add_notifications_table
  e5b8c7d6a4f3  add_order_artwork_print_tracking
  g2f518e9c3b4  add_order_uuid_unique_constraint
"""
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_company_configs_id"), "company_configs", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_pricing_rules_fabric_type"),
        "pricing_rules",
        ["fabric_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_shipping_rates_id"), "shipping_rates", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "add_on_options_total", sa.DECIMAL(precision=10, scale=2), nullable=True
        ),
        ...
        # Added in b1f3c9a6d8a1
        sa.Column("order_uuid", sa.String(), nullable=True),
        sa.Column("slip_booking_url", sa.String(), nullable=True),
        sa.Column("slip_deposit_url", sa.String(), nullable=True),
        sa.Column("slip_balance_url", sa.String(), nullable=True),
        # Added in c3e5f1a9b2d3
        sa.Column("mockup_front_url", sa.String(), nullable=True),
        sa.Column("mockup_back_url", sa.String(), nullable=True),
        # Added in e5b8c7d6a4f3
        sa.Column("artwork_url", sa.String(), nullable=True),
        sa.Column("print_file_url", sa.String(), nullable=True),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_orders_customer_name"), "orders", ["customer_name"], unique=False
    )
    # Unique index on order_uuid (corrected from b1f3c9a6d8a1 + g2f518e9c3b4)
    ...
    op.create_table(
        ...
        sa.Column(
            "item_sizing_surcharge", sa.DECIMAL(precision=10, scale=2), nullable=True
        ),
    ...
    # ------------------------------------------------------------------ #
    # Seed data: neck_types (from f1d407d87638)                          #
    # ------------------------------------------------------------------ #
    op.execute("""
